...
ROOT_URLCONF = 'shan_backend.urls'
...
WSGI_APPLICATION = 'shan_backend.wsgi.application'

# Database - MongoDB via djongo
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': 'shan_associates',
        'CLIENT': {
...
# Email configuration (optional – for sending order confirmations)
